...
class ChainCluster(object):
    ...
    def __eq__(self, other):
        ...
        return (
            ...
            and self.filetuple.filename == other.filetuple.filename
            and self.filetuple.fileindex == other.filetuple.fileindex
        )
...
def get_clustered_ranges(clustersinfiles, npartitions, friendinfo):
    ...
    for partition in clustersbypartition:
        ...
        for _, clustersinsamefileiter in itertools.groupby(
            partition, lambda cluster: cluster.filetuple.fileindex
        ):
        ...
        globalend = (
            lastclusterinpartition.end + lastclusterinpartition.offset - partitionoffset
        )

        clustered_ranges.append(
            TreeRange(
                rangeid,
                globalstart,
                globalend,
